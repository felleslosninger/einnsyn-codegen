...
export function emitEntityModels(
	...
	for (const model of models) {
		...
		if (!model.baseModel) {
			// modelClass.addImplements('no.einnsyn.apiclient.entities.base.models.Base');
			modelClass.setExtends("Resource");
			modelClass.addImport("no.einnsyn.apiclient.common.entity.Resource");
			modelClass.addImplements("no.einnsyn.apiclient.common.entity.HasId");
		}
	...
	for (const model of models) {
		...
		// modelClass.addImplements('no.einnsyn.apiclient.common.entity.HasIdRequest');
