...
import { getValidationAnnotations } from '../../languages/java/helpers/validationAnnotations.js';
...
export function emitControllers(
  ...
  operationsByNamespace.forEach(([namespace, httpOperationList]) => {
    ...
    // Add constructor
    const constructor = new Method(controllerClass, className);
    constructor.addParameter(
      new Parameter(controllerClass, 'service', entityName + 'Service'),
    );
    constructor.addBody(`this.service = service;`);
