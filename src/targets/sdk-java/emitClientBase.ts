...
export function emitClientBase(
	...
	clientBaseClass.addImport("no.einnsyn.sdk.net.ApiRequester");
	...
	const constructorMethod = new Method(clientBaseClass, "EInnsynClientBase");
	constructorMethod.addParameter(
		new Parameter(constructorMethod, "requester", "ApiRequester"),
	);
	constructorMethod.addBody("this.requester = requester;");
